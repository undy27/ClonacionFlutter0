...
class _CartaWidgetState extends State<CartaWidget> with SingleTickerProviderStateMixin {
  ...
  void _initAnimations() {
    ...
    _scaleAnimation = TweenSequence<double>([
      TweenSequenceItem(tween: Tween(begin: 1.0, end: 1.5).chain(CurveTween(curve: Curves.easeOutExpo)), weight: 25),
      TweenSequenceItem(tween: Tween(begin: 1.5, end: 1.0).chain(CurveTween(curve: Curves.elasticOut)), weight: 75),
    ]).animate(_controller!);
